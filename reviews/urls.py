...
from .views import establishment_list, admin_est_list, establishment_detail, add_review, user_profile, register, \
    user_login, user_logout, create_establishment, admin_est_detail, edit_est_info, delete_establishment
